        ...
        <nav className="sticky top-0 z-40 w-full flex items-center justify-between px-8 py-5 bg-[#050505]/80 backdrop-blur-2xl border-b border-[#151515]">
            ...
            <div className="flex items-center gap-6 ml-8">
                <button
                    onClick={triggerSync}
                    disabled={isSyncing}
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-[#2A2A2A] bg-[#111] hover:bg-[#1A1A1A] transition-colors text-xs font-bold font-mono text-zinc-400 hover:text-white disabled:opacity-50"
                >
