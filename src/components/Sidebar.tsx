                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive ? "bg-white/5 text-white" : "text-zinc-600 hover:text-zinc-200 hover:bg-white/5"
                            )}
                            title={item.label}
                        >
                            {isActive && (
                            ...
                            <item.icon className={cn("w-6 h-6 transition-all duration-500", isActive ? "drop-shadow-[0_0_8px_rgba(255,255,255,0.4)]" : "group-hover:scale-110")} />

                            <div className="absolute left-20 px-3 py-1.5 glass-card text-[11px] text-zinc-300 rounded-lg opacity-0 translate-x-[-10px] group-hover:opacity-100 group-hover:translate-x-0 transition-all pointer-events-none whitespace-nowrap font-bold font-mono tracking-widest z-50">
                                {item.label}
                            </div>
                        </Link>
                    )
